...
export default function HtmlMinifier() {
    const { output, setOutput, clearOutput } = useTool('html-minifier')
    ...
    return (
        <ToolLayout toolId="html-minifier">
            <ToolInput value={input} onChange={setInput} onClear={clear} placeholder="Paste HTML here…" />
